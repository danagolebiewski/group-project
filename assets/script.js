...
function pullResults() {
    ...
    fetch(`http://www.mapquestapi.com/geocoding/v1/address?key=${apiKey}&location=${cityNameEl}`)
...
function nameFunction (lng, lat){
    fetch(`http://www.mapquestapi.com/search/v4/place?key=JQBwiKz7mElblzM0fnId15X3ngEynG51&q=restaurants&sort=relevance&location=${lng},${lat}`)
    .then(response => response.json())
    .then(response => {
